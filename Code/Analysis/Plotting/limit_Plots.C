...
void limit_Plots_grand(TString Run, TString indir, TString fileName) {
	...
	double xmin, xmax;
	if (cat == "Axion")  {xmin = freq1 - 100.E-5; xmax = freq2 + 100.E-5;}
	...
	tx.DrawLatex(0.20, 0.74, "Threshold = 3.355");
	...
	//c1name += "_AddStep834_835.png";
	c2name += "_AddStep834_835.png";
	c3name += "_AddStep834_835.png";
	c4name += "_AddStep834_835.png";
...
void GetTotalUnc (TString Run, TString round, int Order, int Window, int Kbin, bool Lq_Wei) {
	...
	TString fName_grand_NoiseUp   = Form("GrandSpectrum_SG_O%d_W%d_NoiseCal_211118_PlusCavityNoise_Plus120mK_NoiseUp_1to839_Kbin%d_z0.75_"
			, Order, Window, Kbin);

	TString fName_grand_NoiseDn   = Form("GrandSpectrum_SG_O%d_W%d_NoiseCal_211118_PlusCavityNoise_Plus120mK_NoiseDn_1to839_Kbin%d_z0.75_"
			, Order, Window, Kbin);
	
	//file for QL uncertainty
	TString fName_grand_QLUp = Form("GrandSpectrum_SG_O%d_W%d_NoiseCal_211118_PlusCavityNoise_Plus120mK_QLUp_1to839_Kbin%d_z0.75_"
			, Order, Window, Kbin);

	TString fName_grand_QLDn = Form("GrandSpectrum_SG_O%d_W%d_NoiseCal_211118_PlusCavityNoise_Plus120mK_QLDn_1to839_Kbin%d_z0.75_"
			, Order, Window, Kbin);

	//file for mis-alignment uncertainy
	TString fName_grand_NoMisUp = Form("GrandSpectrum_SG_O%d_W%d_NoiseCal_211118_PlusCavityNoise_Plus120mK_NoMisAlignment_1to839_Kbin%d_z0.75_"
			, Order, Window, Kbin);

	TString fName_grand_NoMisDn = Form("GrandSpectrum_SG_O%d_W%d_NoiseCal_211118_PlusCavityNoise_Plus120mK_NoMisAlignment_1to839_Kbin%d_z0.75_"
			, Order, Window, Kbin);
