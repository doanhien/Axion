...
if __name__ == "__main__":
        ...
        for ic in range(820, 840):
                start_time = time.time()
        
                mydir       = "/run/user/1000/gvfs/smb-share:server=taseh_nas.local,share=cd102/Axion/cavity {:d}/IQ_RawData/" .format(ic)
                #mydir       = "/run/user/1000/gvfs/smb-share:server=taseh_nas.local,share=cd102/Cavity Thermal study/cavity {:d}/IQ_RawData/" .format(ic)
                ...
                outdir  = "/home/hien/work/axion/analysis/data/PhysicsRun/CD102/FirstScan/FFT/ReRun/"
                #outdir  = "/home/hien/work/axion/analysis/data/PhysicsRun/CD102/CavityThermalCheck/FFT/"
                outdir  += "Step_"
                ...
                for ifile in listfile:
                        ...
                        #if not "210706-105144" in filename:
                        #       continue
                        ...
                        #                print(NSample)
                        fft_power /= 1000  #average in 1second of data
