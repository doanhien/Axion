...
if __name__ == "__main__":
        ...
        for ic in range(61, 76):
                start_time = time.time()
        
                mydir       = "/run/user/1000/gvfs/smb-share:server=taseh_nas.local,share=cd102/Rescan/cavity {:d}/IQ_RawData/" .format(ic)
                #mydir       = "/run/user/1000/gvfs/smb-share:server=taseh_nas.local,share=cd102/RampDownRescan/cavity {:d}/IQ_RawData/" .format(ic)
                ...
                for ifile in listfile:
                        ...
                        #if not "211121-2008" in filename:
                        #        continue
