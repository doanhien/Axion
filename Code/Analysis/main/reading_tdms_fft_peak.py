...
if __name__ == "__main__":
        ...
        for ic in range(30,34):
                start_time = time.time()
        
                mydir       = "/run/user/1000/gvfs/smb-share:server=taseh_nas.local,share=cd102/Rescan/cavity {:d}/IQ_RawData/" .format(ic)
                ...
                outdir  = "/home/hien/work/axion/analysis/data/PhysicsRun/CD102/Rescan/FFT/"
                outdir  += "Step_"
                ...
                for ifile in listfile:
                        ...
                        NPoints    = 20000  # to get freq resolution 100 Hz
                        ...
                        print("NSamples: {:d} " .format(NSample))
                              
                        avg_power = np.fft.fftshift(fft_power)
                        
                        freq  = np.linspace(Fc - Fs/2, Fc + Fs/2, NPoints)
